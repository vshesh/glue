...
![Build Status](https://github.com/vshesh/glue/actions/workflows/python-package.yml/badge.svg)
...
be spit out. Add an `-a` flag at the end if you want a standalone file you can open and look at. 
